...
const getRoleDestination = (userRole: string | null, from?: string): string => {
...
const Auth = () => {
  ...
  const { signIn, signUp, user, userRole, isApproved, approvalStatus, loading } = useAuth();
  ...
  useEffect(() => {
    ...
    navigate(getRoleDestination(userRole, from), { replace: true });
  }, [user, userRole, isApproved, approvalStatus, loading, navigate, from]);
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-heading font-bold text-2xl text-foreground">RouteAce</h1>
          ...
          <div className="mt-6 text-center">
            <p className="text-muted-foreground">
              ...
              <button
                type="button"
                onClick={() => {
                  // Always route new self-serve signups through the company-creation flow.
                  navigate("/signup/create-company");
                }}
