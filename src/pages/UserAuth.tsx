    ...
    try {
      if (isLogin) {
        ...
        toast({
          ...
          description: "Welcome to RouteAce. You have limited access as a standard user.",
        });
        navigate("/user-dashboard");
      }
    } catch (error) {
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            ...
            <h1 className="font-heading font-bold text-xl text-foreground">RouteAce User Portal</h1>
          </div>
